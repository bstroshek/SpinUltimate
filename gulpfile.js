...
if (gulpVersion == 4) {
	...
	gmWatch ? gulp.task('default', gulp.parallel('img', 'styles', 'css', 'scripts', 'browser-sync', 'watch'))
					: gulp.task('default', gulp.parallel('styles', 'css', 'scripts', 'browser-sync', 'watch'));
